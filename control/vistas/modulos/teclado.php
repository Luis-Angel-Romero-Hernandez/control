...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="btn-agregar-teclado btnAgregar">
            <button type="button" class="btn btn-info btn-sm mb-4" data-toggle="modal" data-target="#modal-gestionar-teclado" data-dismiss="modal"> <i class="fas fa-plus-square"></i> Agregar Teclado</button>
        </div>
...
<div class="modal fade" id="modal-gestionar-teclado">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-info">
                <h4 class="modal-title">Gestionar Teclado</h4>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="hidden" id="idTeclado" name="teclado" value="">
    ...
    $(document).ready(function() {
        ...
        var table = $("#tablaImpresora").DataTable({
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, full, meta) {
                    return "<center>" +
                        "<button type='button' class='btn btn-primary btn-sm btnEditar' data-toggle='modal' data-target='#modal-gestionar-teclado'> " +
        ...
        $(".btn-agregar-teclado").on('click', function() {
            accion = "registrar";
        });
        ...
        $('#tablaImpresora tbody').on('click', '.btnEliminar', function() {
            ...
            swal.fire({
                ...
                title: "¡CONFIRMACION!",
                text: "Seguro que desea eliminar el teclado?",
                icon: 'warning',
                ...
                if (resultado.value) {
                    ...
                    // alert("no se modifico la teclado");
                }
        ...
        $("#btnGuardar").on('click', function() {
            ...
            swal.fire({
                title: "¡CONFIRMAR!",
                text: "¿Está seguro que desea registrar el teclado?",
                icon: 'warning',
                showCancelButton: true,
                ...
                if (resultado.value) {
                    ...
                    $.ajax({
                        ...
                        success: function(respuesta) {
                            ...
                            $("#modal-gestionar-teclado").modal('hide');
